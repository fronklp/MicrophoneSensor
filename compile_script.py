...
files_to_compile = ['microphoneSensor']
file_to_compile = 'microphoneSensor'
if len(sys.argv) == 2:
    com_port = '/dev/cu.usbmodem14501'
else:
	com_port = sys.argv[2]
...
if level_of_compilation >= 4:
    cmd = path_win_avr + 'avrdude -patmega328p -P'+'/dev/cu.usbmodem14501'+' -carduino -D -U flash:w:'+file_to_compile+'.hex:i'
    run_command(cmd)
